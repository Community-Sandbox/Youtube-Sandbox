...
#---------------------------------------------------------------
	...
	# Default = Ask  --  Possible Values: Ask | UCx123-BlahBlahExampleID | service_account
your_channel_id = service_account 
...
#--------------------------------------------------------------------------------
	...
	# Default = Ask  --  Possible Values: Ask | ChosenVideos | RecentVideos | EntireChannel | CommunityPost | RecentCommunityPosts | Days
scan_mode = Days
...
channel_to_scan = https://www.youtube.com/c/GrahamStephan
...
recent_videos_amount = 2
	...
	# Scan all videos from X number of days ago until now
days = 5
